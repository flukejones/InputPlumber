    ...
    fn from(capability: Capability) -> Self {
        ...
        match capability {
            ...
            Capability::Keyboard(key) => match key {
                Keyboard::Key0 => Self::KeyboardKey0,
                Keyboard::Key1 => Self::KeyboardKey1,
                Keyboard::Key102nd => Self::KeyboardKey102nd,
                Keyboard::Key2 => Self::KeyboardKey2,
                Keyboard::Key3 => Self::KeyboardKey3,
                Keyboard::Key4 => Self::KeyboardKey4,
                Keyboard::Key5 => Self::KeyboardKey5,
                Keyboard::Key6 => Self::KeyboardKey6,
                Keyboard::Key7 => Self::KeyboardKey7,
                Keyboard::Key8 => Self::KeyboardKey8,
                Keyboard::Key9 => Self::KeyboardKey9,
                Keyboard::KeyA => Self::KeyboardKeyA,
                Keyboard::KeyAgain => Self::KeyboardKeyAgain,
                Keyboard::KeyApostrophe => Self::KeyboardKeyApostrophe,
                Keyboard::KeyB => Self::KeyboardKeyB,
                ...
                Keyboard::KeyComma => Self::KeyboardKeyComma,
                Keyboard::KeyCompose => Self::KeyboardKeyCompose,
                Keyboard::KeyCopy => Self::KeyboardKeyCopy,
                Keyboard::KeyCut => Self::KeyboardKeyCut,
                Keyboard::KeyD => Self::KeyboardKeyD,
                Keyboard::KeyDelete => Self::KeyboardKeyDelete,
                Keyboard::KeyDot => Self::KeyboardKeyDot,
                Keyboard::KeyDown => Self::KeyboardKeyDown,
                Keyboard::KeyE => Self::KeyboardKeyE,
                Keyboard::KeyEdit => Self::KeyboardKeyEdit,
                Keyboard::KeyEjectCD => Self::KeyboardKeyEjectCd,
                Keyboard::KeyEnd => Self::KeyboardKeyEnd,
                Keyboard::KeyEnter => Self::KeyboardKeyEnter,
                Keyboard::KeyEqual => Self::KeyboardKeyEqual,
                Keyboard::KeyEsc => Self::KeyboardKeyEsc,
                Keyboard::KeyF => Self::KeyboardKeyF,
                Keyboard::KeyF1 => Self::KeyboardKeyF1,
                Keyboard::KeyF10 => Self::KeyboardKeyF10,
                Keyboard::KeyF11 => Self::KeyboardKeyF11,
                Keyboard::KeyF12 => Self::KeyboardKeyF12,
                Keyboard::KeyF13 => Self::KeyboardKeyF13,
                Keyboard::KeyF14 => Self::KeyboardKeyF14,
                Keyboard::KeyF15 => Self::KeyboardKeyF15,
                Keyboard::KeyF16 => Self::KeyboardKeyF16,
                Keyboard::KeyF17 => Self::KeyboardKeyF17,
                Keyboard::KeyF18 => Self::KeyboardKeyF18,
                Keyboard::KeyF19 => Self::KeyboardKeyF19,
                Keyboard::KeyF2 => Self::KeyboardKeyF2,
                Keyboard::KeyF20 => Self::KeyboardKeyF20,
                Keyboard::KeyF21 => Self::KeyboardKeyF21,
                Keyboard::KeyF22 => Self::KeyboardKeyF22,
                Keyboard::KeyF23 => Self::KeyboardKeyF23,
                Keyboard::KeyF24 => Self::KeyboardKeyF24,
                Keyboard::KeyF3 => Self::KeyboardKeyF3,
                Keyboard::KeyF4 => Self::KeyboardKeyF4,
                Keyboard::KeyF5 => Self::KeyboardKeyF5,
                Keyboard::KeyF6 => Self::KeyboardKeyF6,
                Keyboard::KeyF7 => Self::KeyboardKeyF7,
                Keyboard::KeyF8 => Self::KeyboardKeyF8,
                Keyboard::KeyF9 => Self::KeyboardKeyF9,
                Keyboard::KeyFind => Self::KeyboardKeyFind,
                Keyboard::KeyForward => Self::KeyboardKeyForward,
                Keyboard::KeyFront => Self::KeyboardKeyFront,
                Keyboard::KeyG => Self::KeyboardKeyG,
                Keyboard::KeyGrave => Self::KeyboardKeyGrave,
                Keyboard::KeyH => Self::KeyboardKeyH,
                Keyboard::KeyHanja => Self::KeyboardKeyHanja,
                Keyboard::KeyHelp => Self::KeyboardKeyHelp,
                Keyboard::KeyHenkan => Self::KeyboardKeyHenkan,
                Keyboard::KeyHiragana => Self::KeyboardKeyHiragana,
                Keyboard::KeyHome => Self::KeyboardKeyHome,
                Keyboard::KeyI => Self::KeyboardKeyI,
                Keyboard::KeyInsert => Self::KeyboardKeyInsert,
                Keyboard::KeyJ => Self::KeyboardKeyJ,
                Keyboard::KeyK => Self::KeyboardKeyK,
                Keyboard::KeyKatakana => Self::KeyboardKeyKatakana,
                Keyboard::KeyKatakanaHiragana => Self::KeyboardKeyKatakanaHiragana,
                Keyboard::KeyKp0 => Self::KeyboardKeyKP0,
                Keyboard::KeyKp1 => Self::KeyboardKeyKP1,
                Keyboard::KeyKp2 => Self::KeyboardKeyKP2,
                Keyboard::KeyKp3 => Self::KeyboardKeyKP3,
                Keyboard::KeyKp4 => Self::KeyboardKeyKP4,
                Keyboard::KeyKp5 => Self::KeyboardKeyKP5,
                Keyboard::KeyKp6 => Self::KeyboardKeyKP6,
                Keyboard::KeyKp7 => Self::KeyboardKeyKP7,
                Keyboard::KeyKp8 => Self::KeyboardKeyKP8,
                Keyboard::KeyKp9 => Self::KeyboardKeyKP9,
                Keyboard::KeyKpAsterisk => Self::KeyboardKeyKpAsterisk,
                Keyboard::KeyKpComma => Self::KeyboardKeyKPComma,
                Keyboard::KeyKpDot => Self::KeyboardKeyKPDot,
                Keyboard::KeyKpEnter => Self::KeyboardKeyKPEnter,
                Keyboard::KeyKpEqual => Self::KeyboardKeyKPEqual,
                Keyboard::KeyKpJpComma => Self::KeyboardKeyKPJpComma,
                Keyboard::KeyKpLeftParen => Self::KeyboardKeyKPLeftParen,
                Keyboard::KeyKpMinus => Self::KeyboardKeyKPMinus,
                Keyboard::KeyKpPlus => Self::KeyboardKeyKPPlus,
                Keyboard::KeyKpRightParen => Self::KeyboardKeyKPRightParen,
                Keyboard::KeyKpSlash => Self::KeyboardKeyKPSlash,
                Keyboard::KeyL => Self::KeyboardKeyL,
                Keyboard::KeyLeft => Self::KeyboardKeyLeft,
                Keyboard::KeyLeftAlt => Self::KeyboardKeyLeftAlt,
                Keyboard::KeyLeftBrace => Self::KeyboardKeyLeftBrace,
                Keyboard::KeyLeftCtrl => Self::KeyboardKeyLeftCtrl,
                Keyboard::KeyLeftMeta => Self::KeyboardKeyLeftMeta,
                Keyboard::KeyLeftShift => Self::KeyboardKeyLeftShift,
                Keyboard::KeyM => Self::KeyboardKeyM,
                Keyboard::KeyMinus => Self::KeyboardKeyMinus,
                Keyboard::KeyMuhenkan => Self::KeyboardKeyMuhenkan,
                Keyboard::KeyMute => Self::KeyboardKeyMute,
                Keyboard::KeyN => Self::KeyboardKeyN,
                Keyboard::KeyNextSong => Self::KeyboardKeyNextSong,
                Keyboard::KeyNumlock => Self::KeyboardKeyNumLock,
                Keyboard::KeyO => Self::KeyboardKeyO,
                Keyboard::KeyOpen => Self::KeyboardKeyOpen,
                Keyboard::KeyP => Self::KeyboardKeyP,
                Keyboard::KeyPageDown => Self::KeyboardKeyPageDown,
                Keyboard::KeyPageUp => Self::KeyboardKeyPageUp,
                Keyboard::KeyPaste => Self::KeyboardKeyPaste,
                Keyboard::KeyPause => Self::KeyboardKeyPause,
                Keyboard::KeyPlayPause => Self::KeyboardKeyPlayPause,
                Keyboard::KeyPower => Self::KeyboardKeyPower,
                Keyboard::KeyPreviousSong => Self::KeyboardKeyPreviousSong,
                Keyboard::KeyProg1 => Self::KeyboardKeyProg1,
                Keyboard::KeyProps => Self::KeyboardKeyProps,
                Keyboard::KeyQ => Self::KeyboardKeyQ,
                Keyboard::KeyR => Self::KeyboardKeyR,
                Keyboard::KeyRecord => Self::KeyboardKeyRecord,
                Keyboard::KeyRefresh => Self::KeyboardKeyRefresh,
                Keyboard::KeyRight => Self::KeyboardKeyRight,
                Keyboard::KeyRightAlt => Self::KeyboardKeyRightAlt,
                Keyboard::KeyRightBrace => Self::KeyboardKeyRightBrace,
                Keyboard::KeyRightCtrl => Self::KeyboardKeyRightCtrl,
                Keyboard::KeyRightMeta => Self::KeyboardKeyRightMeta,
                Keyboard::KeyRightShift => Self::KeyboardKeyRightShift,
                Keyboard::KeyRo => Self::KeyboardKeyRo,
                Keyboard::KeyS => Self::KeyboardKeyS,
                Keyboard::KeyScrollDown => Self::KeyboardKeyScrollDown,
                Keyboard::KeyScrollLock => Self::KeyboardKeyScrollLock,
                Keyboard::KeyScrollUp => Self::KeyboardKeyScrollUp,
                Keyboard::KeySemicolon => Self::KeyboardKeySemicolon,
                Keyboard::KeySlash => Self::KeyboardKeySlash,
                Keyboard::KeySleep => Self::KeyboardKeySleep,
                Keyboard::KeySpace => Self::KeyboardKeySpace,
                Keyboard::KeyStop => Self::KeyboardKeyStop,
                Keyboard::KeyStopCD => Self::KeyboardKeyStopCd,
                Keyboard::KeySysrq => Self::KeyboardKeySysRq,
                Keyboard::KeyT => Self::KeyboardKeyT,
                Keyboard::KeyTab => Self::KeyboardKeyTab,
                Keyboard::KeyU => Self::KeyboardKeyU,
                Keyboard::KeyUndo => Self::KeyboardKeyUndo,
                Keyboard::KeyUp => Self::KeyboardKeyUp,
                Keyboard::KeyV => Self::KeyboardKeyV,
                Keyboard::KeyVolumeDown => Self::KeyboardKeyVolumeDown,
                Keyboard::KeyVolumeUp => Self::KeyboardKeyVolumeUp,
                Keyboard::KeyW => Self::KeyboardKeyW,
                Keyboard::KeyWww => Self::KeyboardKeyWww,
                Keyboard::KeyX => Self::KeyboardKeyX,
                Keyboard::KeyY => Self::KeyboardKeyY,
                Keyboard::KeyYen => Self::KeyboardKeyYen,
                Keyboard::KeyZ => Self::KeyboardKeyZ,
                Keyboard::KeyZenkakuhankaku => Self::KeyboardKeyZenkakuhankaku,
            },
            Capability::Touchpad(touchpad) => match touchpad {
                Touchpad::LeftPad(pad) => match pad {
