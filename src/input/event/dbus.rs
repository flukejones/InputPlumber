...
impl Action {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Action::QuickCustom1 => "ui_quick_custom1",
            Action::QuickCustom2 => "ui_quick_custom2",
...
impl FromStr for Action {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "ui_quick_custom1" => Ok(Action::QuickCustom1),
            "ui_quick_custom2" => Ok(Action::QuickCustom2),
    ...
    match capability {
        ...
        Capability::Gamepad(gamepad) => match gamepad {
            Gamepad::Button(btn) => match btn {
                ...
                GamepadButton::QuickCustom1 => vec![Action::QuickCustom1],
                GamepadButton::QuickCustom2 => vec![Action::QuickCustom2],
